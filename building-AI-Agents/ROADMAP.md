...
- [ ] `09_file_reading_tool`: Add a file-reading tool with path safety.
- [ ] `10_file_editing_tool`: Add a file-editing tool that writes small patches.
- [ ] `11_failure_handling`: Add failure handling for missing tools, bad tool arguments, and max-step exhaustion.
